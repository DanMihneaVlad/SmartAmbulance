...
abstract class $HospitalModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, String name, String address, double lat, double lng});
}
...
class _$HospitalModelImpl implements _HospitalModel {
  ...
  @override
  String toString() {
    return 'HospitalModel(uid: $uid, name: $name, address: $address, lat: $lat, lng: $lng)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, uid, name, address, lat, lng);
...
abstract class _HospitalModel implements HospitalModel {
  const factory _HospitalModel(
      ...
      required final double lng}) = _$HospitalModelImpl;
